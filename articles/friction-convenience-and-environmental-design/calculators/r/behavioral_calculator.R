#!/usr/bin/env Rscript
# Self-contained behavioral calculator for Friction, Convenience, and Environmental Design
...
result <- data.frame(
  series = "Behavior Change and Habit Formation",
  article = "Friction, Convenience, and Environmental Design",
