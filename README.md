# Behavior Change and Habit Formation Code

This repository supports the Sustainable Catalyst **Behavior Change and Habit Formation** knowledge series with reproducible, article-level research scaffolds, synthetic datasets, computational examples, calculator scripts, documentation, and responsible-use notes.

## Repository role

Companion repository for behavior change, habit formation, routines, cues, friction, self-regulation, intervention design, maintenance, and relapse.
...
25 article folders are defined in this repo manifest.

## Focus areas

- habit-loop models
- friction calculators
- maintenance simulations
- behavior change templates
- longitudinal synthetic behavior data
...
https://github.com/Content-Catalyst-LLC/behavior-change-habit-formation-code
